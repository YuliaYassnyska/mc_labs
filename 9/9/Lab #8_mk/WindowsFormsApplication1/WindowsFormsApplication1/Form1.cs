...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            byte[] b1 = new byte[3];
            b1[0] = SLAVE1_ADDRESS;
            b1[1] = 0xA1;//команда запису
            b1[2] = Convert.ToByte( textBox1.Text, 2);
            serialPort1.Write(b1, 0, 3);
        }
        ...
        private void BirthError1_click(object sender, EventArgs e)
        {
            int errorFrame = -1;
            byte[] b1 = new byte[3];
            b1[0] = SLAVE2_ADDRESS;
        ...
        private void BirthError2_Click(object sender, EventArgs e)
        {
            int errorFrame = -1;
            byte[] b1 = new byte[3];
            b1[0] = SLAVE2_ADDRESS;
            b1[1] = 0xD1;//команда Читання
            serialPort1.Write(b1, 0, 2);
            int packetsAmount = serialPort1.ReadByte();
            String message = "";
            for (int i = 0; i < packetsAmount; i++)
        ...
        private void NameError1_Click(object sender, EventArgs e)
        {
            int errorFrame = -1;
            byte[] b1 = new byte[3];
            b1[0] = SLAVE1_ADDRESS;
        ...
        private void NameError2_Click(object sender, EventArgs e)
        {
            int errorFrame = -1;
            byte[] b1 = new byte[3];
            b1[0] = SLAVE1_ADDRESS;
